...
MicroHistory.setUrlHash = (function (jQuery, window) {
    ...
    // Fix logo_item disappearing in Firefox when setting location.hash
    function resetlogo_item () {
        if (navigator.userAgent.indexOf('Firefox') > -1) {
            // Move the link tags for the logo_item to the bottom
            // of the head element to force a reload of the logo_item
            $('head > link[href="logo_item\\.ico"]').appendTo('head');
        }
    }
